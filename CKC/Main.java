...
public class Main {
    ...
    public static int userAuthentication(String fname, String id, String phone) {
        ...
        try {
            outStream = new PrintWriter(new FileOutputStream("UserFile.txt", true));
            inStream = new Scanner(new FileInputStream("UserFile.txt"));
    ...
    public static void deleteRider(String remove, String filename) {
        ...
        try {
            ...
            inStream = new Scanner(new FileInputStream("Trips\\" + filename + ".txt"));
        } catch (FileNotFoundException e) {
            System.out.println("Error Occured");
        }
        while (inStream.hasNextLine()) {
        ...
        inStream.close();
        outStream.close();
        File file = new File("Trips\\" + filename + ".txt");
        file.delete();
                ...
                while (cont) {
                    ...
                    switch (option) {
                        ...
                        case "T":
                            ...
                            if (Trip.allTrips.containsKey(time + src + dest + date)) {
                                ...
                                try {
                                    outStream = new PrintWriter(new FileOutputStream(
                                            "Trips\\" + time + src + dest + date + ".txt", true));
                                } catch (FileNotFoundException e) {
                                    System.out.println("Error Occured");
                                }
                            ...
                            break;
                        case "C":
                            System.out.println("Enter the Trip ID to get Trip details");
                            System.out.println("<Time><source><destination><date>");
                            ...
                            break;
                        case "A":
                            System.out.println("Enter the Trip ID to get Accept ride");
                            System.out.println("<Time><source><destination><date>");
                            ...
                            break;
                        case "R":
                        System.out.println("Enter the Trip ID to get Reject ride");
                        System.out.println("<Time><source><destination><date>");
